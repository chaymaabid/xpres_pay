...
import { CheckoutItem, ShippingData } from '@/services/order.service';
...
export default function Step2Shipping({ items, initialShipping, onBack, onConfirm, isLoading }: Props) {
          ...
          <div className="space-y-4">
            ...
            <Field label="Street Address" error={errors.streetAddress}>
              <input
                ...
                placeholder="1248 Rural Route 5"
                className={input(!!errors.streetAddress)}
              />
            </Field>
